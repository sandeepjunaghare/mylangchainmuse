...
var Format = class {
  constructor(data, this_response_nsig_cache) {
    ...
    if (this.has_audio || this.has_text) {
      ...
      this.language = ((_e = xtags === null || xtags === void 0 ? void 0 : xtags.find((x) => x.startsWith("lang="))) === null || _e === void 0 ? void 0 : _e.split("=")[1]) || null;
      if (this.has_audio) {
        const audio_content = (_f = xtags === null || xtags === void 0 ? void 0 : xtags.find((x) => x.startsWith("acont="))) === null || _f === void 0 ? void 0 : _f.split("=")[1];
...
var { homepage, version, bugs } = { "homepage": "https://github.com/LuanRT/YouTube.js#readme", "version": "9.3.0", "bugs": { "url": "https://github.com/LuanRT/YouTube.js/issues" } };
